...
class DataBowl3Detector(Dataset):
	...
	self.pad_value = config['pad_value']
        ...
        for idx in idcs:
            if not os.path.exists(os.path.join(data_dir, '%s_label.npy' %idx)):
                print (os.path.join(data_dir, '%s_label.npy' %idx), 'not exists')
                continue
	...
	#	label[label==-1]=0
            ...
            try:
                ...
                print (self.filenames[idx], ' is not existed')
